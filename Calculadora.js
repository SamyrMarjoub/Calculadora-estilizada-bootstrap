...
bt1.addEventListener('click', function () {
    ...
    pai.style.backgroundColor = '#252c46'
...
bt2.addEventListener('click', function () {
    ...
    filho.style.backgroundColor = '#c05602'
    pai.style.backgroundColor = '#d3cdcd'
...
bt3.addEventListener('click', function () {
    ...
    filho.style.backgroundColor = '#06d7d1'
    pai.style.backgroundColor = '#1e0836'
